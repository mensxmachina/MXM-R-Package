#class object for SES.gee output

#Class SES.gee.output

#SES.gee.output object
...
setClass(Class='SES.gee.output', 
         slots=list(selectedVars='numeric', selectedVarsOrder='numeric', queues='list', signatures='matrix', hashObject='list', pvalues='numeric', stats='numeric', max_k='numeric', univ = 'list',threshold='numeric', runtime='proc_time', test='character', correl='character', se='character'), 
         prototype=list(selectedVars=NULL, selectedVarsOrder=NULL, queues=NULL, signatures=NULL, hashObject=NULL, pvalues=NULL, stats=NULL, univ=NULL, max_k=NULL, threshold=NULL, runtime=NULL, test=NULL, correl=NULL, se=NULL));


setMethod("plot", signature(x="SES.gee.output"), 
          function(x,mode="all", ...){
